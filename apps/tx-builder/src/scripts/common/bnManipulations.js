...
export function bigintToArrayBitwise(n, k, x) {
...
export function bigintToUint8Array(x) {
...
export function bigintToUint8ArrayBitwise(x) {
...
export function Uint8ArrayToBigint(x) {
  let ret = 0n;
...
export function Uint8ArrayToBigintBitwise(x) {
  let ret = 0n;
