...
const TransactionsProvider: FC<PropsWithChildren> = ({ children }) => {
  ...
  // TODO: replace any with real typing
  const reorderTransactions = useCallback((sourceIndex: any, destinationIndex: any) => {
    setTransactions(transactions => {
